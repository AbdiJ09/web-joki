        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-start g-4">
                <div class="col-md-4 position-relative">
                    <div class="shadow-lg sec-left mb-4">
                        ...
                        <div class="content-text text-start mt-5">
                            <h2 class="fw-normal pt-5">Joki <span style="color: gold">Classic</span></h2>
                ...
                <div class="col-md-8">
                    ...
                    <form action="{{ route('order.joki-classic.payment') }}" method="post" id="order-classic">
                        @csrf
                        ...
                        <div class="form-account shadow sec-right mb-4">
                            ...
                            <div class="row g-4 mt-1">
                                ...
                                <div class="col-md-6">
                                    <div class="mt-1">
                                        <input type="text" name="requestHero" id="request_hero"
                                            class="form-control focus-ring" placeholder="Request Hero">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mt-1">
                                        <input type="text" name="Note" id="note"
                                            class="form-control focus-ring" placeholder="Catatan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mt-1 mb-3">
                        ...
                        <div class="select-rank shadow sec-right mb-4">
                                ...
                                @foreach ($classic as $item)
                                    <div class="col-lg-4">
                                        <input type="radio" class="btn-check" name="Nominal"
                                            ...
                                            value="{{ $item->name_classic }} / Star">
                                        <label class="btn text-start" for="rank{{ $loop->iteration }}">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="row fw-semibold">
                                                        <div class="col">{{ $item->name_classic }} / Star</div>
                                                    </div>
                                                    <div class="row fst-italic">
                                                        <div class="col">
                                                            Rp <span
                                                                class="price-rank">{{ number_format($item->price, 0, '.', '.') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="total-star shadow sec-right mb-4 mt-4">
                                <h1 class="text-center fw-normal">Masukkan Jumlah Wins</h1>
                                <div class="mt-3">
                            ...
                            <div class="payment-method shadow sec-right mb-4">
                                ...
                                <div class="payment-drawwer mt-4">
                                    ...
                                    <div class="footer-payment" onclick="paymentOpen()">
                                        ...
                                        <img src="/img/payment-logos/OVO.png" alt="" class="bg-white"
                                            width="24" height="13">
                                    ...
                                    <div class="modal-content verifikasi-content">
                                        ...
                                        <div class="modal-body fs-5 text-white verifikasi-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 verif-order">
                                                    <p><i class="bi bi-person-check"></i> Request Hero : <span
                                                            id="requestHero-display"></span></p>

                                                </div>
                                                <div class="col-md-6 verif-order">
                                                    <p><i class="bi bi-person-check"></i> Catatan : <span
                                                            id="Note-display"></span></p>
